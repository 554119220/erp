<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-20 15:19:44
         compiled from ".\Application\Home\View\Hrm\register.html" */ ?>
<?php /*%%SmartyHeaderCode:1495754feae33aba951-44510113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa881af5abc555ac1a731009f4d3634accb7e6bf' => 
    array (
  ...
  'nocache_hash' => '1495754feae33aba951-44510113',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_54feae33bebc21_97526137',
  'variables' => 
  array (
    'publicUrl' => 0,
    'formUrl' => 0,
...
<?php if ($_valid && !is_callable('content_54feae33bebc21_97526137')) {function content_54feae33bebc21_97526137($_smarty_tpl) {?><!DOCTYPE html>
<html>
  <head>
...
/js/tp-register.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['publicUrl']->value;?>
/js/tp-region.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['publicUrl']->value;?>
/js/tp-hrm.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['publicUrl']->value;?>
/js/tp-transport.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['publicUrl']->value;?>
...
" ><?php echo $_smarty_tpl->tpl_vars['val']->value['role_name'];?>
            ...
            <td>
              <input class="datePicker" type="text" name="joined_date" value="" placeholder="入职日期">
            </td>
            <th>公司宿舍</th>
            <td>
          ...
          <tr>
            ...
            <th>出生日期</th>
            <td>
              <input class="datePicker" type="text" name="birthday" value="" placeholder="农历" >
            </td>
...
"><?php echo $_smarty_tpl->tpl_vars['val']->value;?>
          ...
          <tr>
            <td>
              <input class="datePicker" type="text" name="edu_start[]" value="" >
            </td>
            <td>
              <input class="datePicker" type="text" name="edu_end[]" value="" >
            </td>
          ...
          <!-- 工作经历 -->
          <tr>
            <th rowspan="5">工作经历</th>
            <td colspan="6">
              <span style="font-size:13px;color:#999;padding-left:12px;">
                请务必详细填写以往工作经历，包括工作主要职责、具体工作内容和所取成绩</span>
            </td>
          </tr>
          <tr>
            <th>日期</th>
            <td>
              <input class="datePicker" type="text" name="joined_date" value="" placeholder="日期">
            </td>
            <th>工作单位</th>
            <td></td>
            <th>职位及职责</th>
