<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-16 16:31:54
         compiled from ".\Application\Home\View\Hrm\editRegister.html" */ ?>
<?php /*%%SmartyHeaderCode:23169550694fad97019-09434240%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '23169550694fad97019-09434240',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_550694fb0f4240_45511228',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550694fb0f4240_45511228')) {function content_550694fb0f4240_45511228($_smarty_tpl) {?><!DOCTYPE html>
<html>
  <head>
...
" id="job_title" placeholder="应聘或当前职位"/></td>
            <td>
              <input  type="text" name="joined_date" value="<?php echo $_smarty_tpl->tpl_vars['base']->value['joined_date'];?>
" placeholder="入职日期">
            </td>
            <th>公司宿舍</th>
            <td>
...
"/></td>
            ...
            <th>出生日期</th>
            <td>
              <input type="text" name="birthday" value="<?php echo $_smarty_tpl->tpl_vars['base']->value['birthday'];?>
" placeholder="农历" >
            </td>
...
" maxlength="3"/></td>
            <th>婚姻状况</th>
            <td>
              &nbsp;<label><input type="radio" name="marital_status" value="0" <?php if ($_smarty_tpl->tpl_vars['base']->value['marital_status']=='未婚') {?>checked<?php }?>/>未婚</label>
              <label><input type="radio" name="marital_status" value="1" <?php if ($_smarty_tpl->tpl_vars['base']->value['marital_status']=='已婚') {?>checked<?php }?>//>已婚</label>
            </td>
          </tr>
          <tr>
            <th>学历</th>
            <td>
              <select name="education">
                <option value="0" <?php if ($_smarty_tpl->tpl_vars['base']->value['education']=='初中') {?>selected<?php }?>>初中</option>
                <option value="1" <?php if ($_smarty_tpl->tpl_vars['base']->value['education']=='高中/中专') {?>selected<?php }?>>高中/中专</option>
                <option value="2" <?php if ($_smarty_tpl->tpl_vars['base']->value['education']=='大专') {?>selected<?php }?>>大专</option>
                <option value="3" <?php if ($_smarty_tpl->tpl_vars['base']->value['education']=='本科') {?>selected<?php }?>>本科</option>
                <option value="4" <?php if ($_smarty_tpl->tpl_vars['base']->value['education']=='硕士') {?>selected<?php }?>>硕士</option>
              </select>
            </td>
            <th>籍贯</th>
            <td>
...
" placeholder="务必填写常用邮箱"/></td>
          ...
          <!-- 教育经历 -->
          <tr>
            <th rowspan="<?php if ($_smarty_tpl->tpl_vars['edu']->value) {
echo $_smarty_tpl->tpl_vars['edu_count']->value;
} else { ?>4<?php }?>">教育经历</th>
            <th>开始日期</th>
            <th>结束日期</th>
...
?>
          <tr>
            <td>
              <input type="text" name="edu_start[]" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['edu_start'];?>
">
            </td>
            <td>
              <input type="text" name="edu_end[]" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['edu_end'];?>
">
            </td>
...
<tr>
         ...
         <?php }?> 
          ...
          <!-- 工作经历 -->
          <tr>
            <th rowspan="<?php if ($_smarty_tpl->tpl_vars['work']->value) {
echo $_smarty_tpl->tpl_vars['work_count']->value;
} else { ?>4<?php }?>">工作经历</th>
            <th>开始日期</th>
            <th>结束日期</th>
...
?>
          <tr>
            <td>
              <input type="text" name="work_start[]" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['work_start'];?>
" >
            </td>
            <td>
              <input type="text" name="work_end[]" value="<?php echo $_smarty_tpl->tpl_vars['val']->value['work_end'];?>
" >
            </td>
...
"/></td>
            <th>联系电话</th><td colspan="2"> <input type="text" name="contact_phone[]" value="<?php if ($_smarty_tpl->tpl_vars['emergency2']->value['phone']) {
echo $_smarty_tpl->tpl_vars['emergency2']->value['phone'];
}?>" maxlength="11"/></td>
          </tr>
          <tr><td colspan="7"></td></tr>
          <tr>
