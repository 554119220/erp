<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-23 17:39:32
...
/addApproval" method="POST" onsubmit="return validatValue(this)">
...
?>
    <tr>
      ...
      <td>
        <input type="button" value="修改" class="btn-link" 
        onclick="controlVacate(<?php echo $_smarty_tpl->tpl_vars['val']->value['approve_id'];?>
,'edit')"/>
