<?php /* Smarty version Smarty-3.1.6, created on 2015-01-16 11:47:03
         compiled from "./Application/Home/View\Usersmanage\usersDetail.html" */ ?>
<?php /*%%SmartyHeaderCode:1641354b889b78d24d2-62911494%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1641354b889b78d24d2-62911494',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54b889b7e8b25',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54b889b7e8b25')) {function content_54b889b7e8b25($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\xampp\\htdocs\\thinkphp\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
<?php if ($_smarty_tpl->tpl_vars['user']->value['card_number']){?>：<?php echo $_smarty_tpl->tpl_vars['user']->value['card_number'];?>
<?php }?></td>
          <th>已有积分：</th>
...
" /></a><?php }?><?php echo $_smarty_tpl->tpl_vars['user']->value['aliww'];?>
...
:17"></a><?php }?><?php echo $_smarty_tpl->tpl_vars['user']->value['qq'];?>
...
<?php echo $_smarty_tpl->tpl_vars['user']->value['district'];?>
...
>
              ...
              <td valign="top"><?php if ($_smarty_tpl->tpl_vars['order']->value['final_amount']==9.9){?>36.00<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['order']->value['final_amount'];?>
<?php }?></td>
...
：<?php if ($_smarty_tpl->tpl_vars['order']->value['order_sn']){?><?php echo $_smarty_tpl->tpl_vars['order']->value['order_sn'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['order']->value['shipping_name'];?>
<?php }?></a><?php echo $_smarty_tpl->tpl_vars['order']->value['shipping_name'];?>
</summary>
...
?>
          <tr>
            <td>
              通过<?php if ($_smarty_tpl->tpl_vars['val']->value['exchange_points']>0){?><?php if ($_smarty_tpl->tpl_vars['val']->value['integral_way']==1){?><?php echo $_smarty_tpl->tpl_vars['val']->value['integral_title'];?>
<?php echo $_smarty_tpl->tpl_vars['val']->value['goods_amount'];?>
元<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['val']->value['integral_title'];?>
<?php }?>
              <?php if ($_smarty_tpl->tpl_vars['val']->value['confirm']==0){?>将获得<?php }else{ ?>获得<?php }?><?php echo $_smarty_tpl->tpl_vars['val']->value['exchange_points'];?>
积分
              <?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['val']->value['integral_title'];?>
...
?>
          <tr>
            <td>
              <?php if ($_smarty_tpl->tpl_vars['val']->value['first']==1){?> <img src="images/yes.gif" /><?php }?><?php echo $_smarty_tpl->tpl_vars['val']->value['user_name'];?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['val']->value['real_parent']==1){?><font color="#3367AC">【家长】</font><?php }?></td>
